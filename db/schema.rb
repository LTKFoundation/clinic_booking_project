...
ActiveRecord::Schema.define(version: 20161212092848) do
  ...
  create_table "medic_record_views", force: :cascade do |t|
    t.integer  "patient_id"
    t.integer  "doctor_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_medic_record_views_on_doctor_id", using: :btree
    t.index ["patient_id"], name: "index_medic_record_views_on_patient_id", using: :btree
  end
  ...
  add_foreign_key "medic_record_views", "doctors"
  add_foreign_key "medic_record_views", "patients"
